...
import { getConnectionLandingHtml, getConnectionForm, getEmailCheck, get2FACheck, initConnectionPageListeners} from './auth/connectionPage';
...
router.addRoute('/connection/tfacheck', get2FACheck);
